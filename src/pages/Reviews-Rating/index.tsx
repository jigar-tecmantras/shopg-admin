...
const ReviewRating = (): React.JSX.Element => {
  ...
  const reviews = [
    ...
    },
    {
      ...
      name: 'Patrick Kelly',
      subTitle:
        'Very good support and also code works brilliantly and well documented',
    },
    {
      id: 4,
      img: avatar1,
    ...
    },
    {
      ...
      name: 'Jacques Leon',
      subTitle:
        'Works like a component library, a crazy amount of design elements already built and given.',
    },
  ];
  return (
    <React.Fragment>
