...
const TwoStepVerify = (): React.JSX.Element => {
  document.title = 'Two Step Verify | Warehouse';

  const moveToNext = (index: number): void => {
    const nextEle = document.getElementById('digit' + index + '-input');
