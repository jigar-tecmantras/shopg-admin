...
const SearchModal = (): React.JSX.Element => {
  ...
  const onChangeData = (value: any): void => {
    setValue(value);
  };

  useEffect(() => {
    // Search bar
    const searchOptions = searchCloseOptions.current;
      ...
      searchInput.addEventListener('keyup', function () {
        ...
        if (inputLength > 0) {
          ...
          Array.from(notifyItem).forEach(function (element: any) {
            let notifiTxt = '';
            if (element.querySelector('h6') != null) {
              const spantext = element
                .getElementsByTagName('span')[0]
                .innerText.toLowerCase();
              const name = element.querySelector('h6').innerText.toLowerCase();
              if (name.includes(inputVal) != null) {
                notifiTxt = name;
              } else {
                notifiTxt = spantext;
              }
            } else if (element.getElementsByTagName('span') != null) {
              notifiTxt = element
                .getElementsByTagName('span')[0]
                .innerText.toLowerCase();
            }
  ...
  return (
    <React.Fragment>
      <Button
        ...
        className="px-3 fs-15 user-name-text header-item d-none d-md-block">
        <span className="bi bi-search me-2"></span> Search for Warehouse...
      </Button>
